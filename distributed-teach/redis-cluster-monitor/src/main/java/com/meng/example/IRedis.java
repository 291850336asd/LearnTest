...
public interface IRedis {
     ...
     *     parameters 必需，方法参数集合，此处若方法参数包括business，
     *     则business参数一定不要，即此集合包括调用方法除business的参数。
     *
     * 若采用Command(CommandTypeEnum commandName, Object... coms)构造则：
     *      commandName 必需，RedisClusterImpl的方法枚举名称
     *      coms 方法参数集合，必须与所调用的方法参数个数及类型相同，
     *      此处若方法参数包括business，则business参数一定不要，
     *      即此集合包括调用方法除business的参数。
     * @param business
     * @param commands
     * @return
     */
