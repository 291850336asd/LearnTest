package com.meng.example.jeids;
...
//                    connection = connectionHandler.getConnectionFromSlot(JedisClusterCRC16.getCRC16(key));
                    connection = (Jedis)reflectConnectionHandler(JedisSlotBasedConnectionHandler.class, "getConnectionFromSlot",
                            JedisClusterCRC16.getCRC16(key));
                }
            }
