...
public class SpringControllerCollects extends AbstractCollects implements Collect {
    ...
    static {
        ...
        sbuilder.append("com.meng.apm.service.monitor.collects.SpringControllerCollects instance= ");
        sbuilder.append("com.meng.apm.service.monitor.collects.SpringControllerCollects.INSTANCE;\r\n");
        sbuilder.append("com.meng.apm.service.monitor.collects.SpringControllerCollects.WebStatistics statistic =" +
                "(com.meng.apm.service.monitor.collects.SpringControllerCollects.WebStatistics)instance.begin(\"%s\",\"%s\");");
